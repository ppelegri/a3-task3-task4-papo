...
**Takeaway:** Compared to the Red Urchins, The Purple Urchins have a smaller mean and median size, and a tighter spread. The Purple Urchins are quite a bit smaller. Their median size is 2.5 cm smaller than the median size of Red Urchins; in percentage terms the Purple Urchins are 36% than the Red Urchins. 
